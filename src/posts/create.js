...
module.exports = function (Posts) {
	Posts.create = async function (data) {
		...
		const { uid, tid, _activitypub, sourceContent, visibility } = data;
		...
		let postData = { pid, uid, tid, content, sourceContent, timestamp, visibility, isEnglish, translatedContent };
