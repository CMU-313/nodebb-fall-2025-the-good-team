...
postsAPI.toggleVisibility = async function (caller, data) {
	...
	try {
		...
		isInstructor = !!(
			userData &&
			userData.role &&
			String(userData.role).toLowerCase() === 'instructor'
		);
	} catch (e) {
