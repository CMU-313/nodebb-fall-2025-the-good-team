...
const { setupApiRoute, setupAdminPageRoute } = (_b = require.main) === null || _b === void 0 ? void 0 : _b.require('./src/routes/helpers');
const { formatApiResponse } = (_c = require.main) === null || _c === void 0 ? void 0 : _c.require('./src/controllers/helpers');
...
function controllers({ router, middleware }) {
    ...
    const uploadEmoji = (req, res, next) => {
        ...
        const fileName = (0, path_1.basename)(req.body.fileName);
        (0, fs_1.rename)(req.file.path, (0, path_1.join)(nconf.get('upload_path'), 'emoji', fileName), (err) => {
            if (err) {
                next(err);
            }
            else {
    ...
    const upload = (0, multer_1.default)({
        dest: (0, path_1.join)(nconf.get('upload_path'), 'emoji'),
    });
